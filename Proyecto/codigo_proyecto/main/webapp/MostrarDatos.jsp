  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="/ProcesadoresAMD">AMD</a>
        </div>
      </li>
    </ul>
    <form class="form-inline my-2 my-lg-0" action="/busqueda">
      <input class="form-control mr-sm-2" type="search" placeholder="Referencia o cod.fabricante" name="palabra" aria-label="Search">
